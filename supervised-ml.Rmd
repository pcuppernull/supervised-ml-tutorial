...
For `caret`, you can set some macro options for the models. Here, I am opting to use "10 Fold Cross Validation". This is a technique that helps you balnce the bias-varoance tradeoff in the estimated models.
